...
namespace ShootingGame.GameComponent
{
    public class NewCamera
    {
        ...
        public NewCamera(Viewport viewPort) : this(viewPort, new Vector3(0, 1, 15), 0, 0)
        {
            //calls the constructor below with default startingPos and rotation values
        }

        public NewCamera(Viewport viewPort, Vector3 startingPos, float lrRot, float udRot)
        {    
        ...
        public void Update(MouseState currentMouseState, KeyboardState keyState, GamePadState gamePadState)
        {
            ...
            if (keyState.IsKeyDown(Keys.Up) || keyState.IsKeyDown(Keys.W))      //Forward
                AddToCameraPosition(new Vector3(0, 0, -5));
